...
| 2022-12-20 | 封装Socket类。<br />观看完视频58p-60p，并实现对于的代码。<br />将socket类与Address类、FdManager类、IOManager类进行结合。可以实现socket通信功能。<br />创建Socket类并没有创建socket，只有在newSock的时候才会创建socket。<br />Socket类封装：util10 |
